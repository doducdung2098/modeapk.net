...
if ( is_single() ) :
	...
	if ( !is_wp_error($terms) && !empty($terms) ) {
		...
		foreach ( $parents as $parent ) {
			if ( $parent == 'game' || $parent == 'games' )
				$category = 'GameApplication';
			elseif ( $parent == 'application' || $parent == 'applications' || $parent == 'app' || $parent == 'apps' )
				$category = 'UtilitiesApplication';
		}
	}

	if ( get_field('_require') )
		$os = get_field('_require');
	else
		$os = 'Android';
